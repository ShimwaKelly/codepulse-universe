  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "grid-pattern-kids": "linear-gradient(to right, rgba(75, 0, 130, 0.1) 1px, transparent 1px), linear-gradient(to bottom, rgba(75, 0, 130, 0.1) 1px, transparent 1px)"
      },
    }
  },
